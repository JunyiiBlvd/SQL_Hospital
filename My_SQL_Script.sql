...
CREATE DATABASE TheMySQLHospital;

use TheMySQLHospital;

-- //////////////////////////////////////////////////////////////////////////////////////////////////// --
  /*Creates ALL The Tables and adds their corresponding Primary Keys*/

Create table Doctor(DEmployee_ID smallint unsigned NOT NULL,
CONSTRAINT pk_DEmployee_ID PRIMARY KEY (DEmployee_ID),  
NEmployee_ID smallint unsigned, 
Doctor_Specialty tinyint unsigned NOT NULL,
Salary Decimal(9,2) NOT NULL,
Employee_ID smallint unsigned NOT NULL);

CREATE TABLE Nurse(NEmployee_ID smallint unsigned NOT NULL, 
constraint pk_NEmployee_ID Primary key (NEmployee_ID),
Nurse_Specialty tinyint unsigned NOT NULL,
Wage  decimal(4,2) NOT NULL,
Employee_ID smallint unsigned NOT NULL);

CREATE TABLE Registration(REmployee_ID smallint unsigned NOT NULL,
constraint pk_REmployee_ID Primary key (REmployee_ID),
Wage decimal(4,2) NOT NULL,
Employee_ID smallint unsigned NOT NULL);

Create Table Treatment(Treatment_ID smallint unsigned NOT NULL,
constraint pk_Treatment_ID primary key(Treatment_ID),
Patient_ID smallint unsigned NOT NULL,
DEmployee_ID smallint unsigned NOT NULL,
Date_ date NOT NULL,
Medicine_ID CHAR(5),
Treatment_Type tinyint unsigned NOT NULL,
Appointment_ID smallint unsigned NOT NULL);

Create Table Treatment_Diagnosis(Treatment_ID smallint unsigned NOT NULL,
constraint pk_Treatment_Diagnosis_ID primary key (Treatment_ID, Diagnosis),
Diagnosis tinyint unsigned NOT NULL);

Create Table Discharge(Discharge_ID smallint unsigned NOT NULL, 
constraint pk_Discharge_ID primary key (Discharge_ID),
Patient_ID smallint unsigned NOT NULL, 
Date_ Date NOT NULL);

Create Table Patient(Patient_ID smallint unsigned NOT NULL,
...
Create Table Outpatient(Opatient_ID smallint unsigned NOT NULL,
constraint pk_Opatient_ID primary key(Opatient_ID),
Bill_ID smallint unsigned NOT NULL);

Create Table Resident_Patient(RPatient_ID smallint unsigned NOT NULL,
constraint pk_Rpatient_ID primary key(Rpatient_ID),
Room_ID smallint unsigned NOT NULL,
Appointment_ID smallint unsigned NOT NULL);

Create Table Appointment(Appointment_ID smallint unsigned NOT NULL,
constraint pk_Appointment_ID primary key(Appointment_ID),
REmployee_ID smallint unsigned NOT NULL,
Date_ DATE NOT NULL);

Create Table Bill(Bill_ID smallint unsigned NOT NULL,
constraint pk_Bill_ID primary key(Bill_ID),
REmployee_ID smallint unsigned NOT NULL,
Insruance_ID smallint unsigned NOT NULL);

CREATE TABLE Medical_Record(Record_ID smallint unsigned NOT NULL,
constraint pk_Record_ID primary key(Record_ID),
Patient_ID smallint unsigned NOT NULL,
REmployee_ID smallint unsigned NOT NULL,
NEmployee_ID smallint unsigned NOT NULL);

Create Table Medical_Record_Medications(Record_ID smallint unsigned NOT NULL,
constraint pk_MRM primary key(Record_ID, Medicine_ID),
Medicine_ID Char(5) NOT NULL);

Create Table Medical_Record_Allergies(Record_ID smallint unsigned NOT NULL,
constraint pk_MRA primary key(Record_ID, Allergy),
Allergy tinyint unsigned NOT NULL);

Create Table Medical_Record_Past_Diagnosis(Record_ID smallint unsigned NOT NULL,
constraint pk_MRPD primary key (Record_ID, Diagnosis),
Diagnosis tinyint unsigned NOT NULL,
Date_ date NOT NULL);

Create Table Triage(Triage_ID smallint unsigned NOT NULL,
...
Date_ date NOT NULL,
Medicine_ID CHAR(5),
Triage_Type tinyint unsigned NOT NULL);

Create Table Room(Room_ID smallint unsigned NOT NULL,
constraint pk_Room_ID primary key(Room_ID),
Room_Type VARCHAR(30) NOT NULL);

Create Table Supplier(Supplier_ID smallint unsigned NOT NULL,
constraint pk_Supplier_ID primary key(Supplier_ID),
Supplier_Name VARCHAR(30) NOT NULL,
Supplier_Address VARCHAR(50) NOT NULL);

Create Table Order_ (Order_ID smallint unsigned NOT NULL,
constraint pk_Order_ID primary key(Order_ID),
Supplier_ID smallint unsigned NOT NULL,
Hospital_ID smallint unsigned NOT NULL,
Order_Date date NOT NULL);

Create Table Order_Line(Order_ID smallint unsigned NOT NULL,
constraint pk_OL primary key(Order_ID, Supplier_ID),
Supplier_ID smallint unsigned NOT NULL,
Quantity smallint NOT NULL);

Create Table Hospital(Hospital_ID smallint unsigned NOT NULL,
constraint pk_Hospital_ID primary key(Hospital_ID),
Hospital_Name VARCHAR(30) NOT NULL,
Hospital_Address VARCHAR(30) NOT NULL);

Create Table Medicine(Medicine_ID Char(5) NOT NULL,
constraint pk_Medicine_ID primary key(Medicine_ID),
Hospital_ID smallint unsigned NOT NULL,
Quantity smallint NOT NULL,
Expiration date NOT NULL);

Create Table Employee(Employee_ID smallint unsigned NOT NULL,
...
Create Table Nurse_Specialty_Lookup(Code_ tinyint unsigned NOT NULL,
constraint pk_NS_Lookup primary key(Code_),
Value_ VARCHAR(30) NOT NULL);

Create Table Doctor_Specialty_Lookup(Code_ tinyint unsigned NOT NULL,
constraint pk_DS_Lookup primary key(Code_),
Value_ VARCHAR(30) NOT NULL);

Create Table Treatment_Type_Lookup(Code_ tinyint unsigned NOT NULL,
constraint pk_Treatment_Lookup primary key(Code_),
Value_ VARCHAR(50) NOT NULL);

Create Table Triage_Type_Lookup(Code_ tinyint unsigned NOT NULL,
constraint pk_TT_Lookup primary key(Code_),
Value_ VARCHAR(30) NOT NULL);

Create Table Severity_Lookup (Code_ tinyint unsigned NOT NULL,
constraint pk_Severity_Lookup primary key(Code_),
Value_ VARCHAR(30) NOT NULL);

Create Table Diagnosis_Lookup(Code_ tinyint unsigned NOT NULL,
constraint pk_Diagnosis_Lookup primary key(Code_),
Value_ VARCHAR(50) NOT NULL);

Create Table Allergy_Lookup(Code_ tinyint unsigned NOT NULL,
constraint pk_Allergy_Lookup primary key(Code_),
Value_ VARCHAR(30) NOT NULL);

Create Table Employee_Type_Lookup(Code_ Char(1) NOT NULL,
constraint pk_ET_Lookup primary key(Code_),
Value_ VARCHAR(30) NOT NULL);

Create Table Clearance_Lookup(Code_ tinyint unsigned NOT NULL,
